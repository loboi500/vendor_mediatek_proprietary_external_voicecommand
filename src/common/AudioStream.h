...
{
public:
    AudioStream(audio_source_t inputSource=AUDIO_SOURCE_HOTWORD, uint32_t sampleRate=16000, uint32_t channelCount=1, audio_session_t session_id=AUDIO_SESSION_ALLOCATE, bool isHotwordTraining=true);
    ~AudioStream();
